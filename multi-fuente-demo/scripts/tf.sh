...
#
# Reusa el bucket de tfstate de data-platform (mismo proceso, prefijo
# de key distinto: multi-fuente-demo/...) — es infraestructura de
...
# fuentes/x/infra -> key multi-fuente-demo/fuentes/x/{env}/terraform.tfstate
STATE_KEY="multi-fuente-demo/${MODULE_PATH%/infra}/${ENV}/terraform.tfstate"
