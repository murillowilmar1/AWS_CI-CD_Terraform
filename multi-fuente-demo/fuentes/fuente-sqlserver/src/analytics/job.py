...
def main():
    print(
        f"[sqlserver/analytics] Agregando s3://{args['STAGE_BUCKET']}/{args['SOURCE_PREFIX']}/ "
    ...
    # Catalog compartido (el mismo que usa postgres) para poder
    # consultarlo desde Athena.
