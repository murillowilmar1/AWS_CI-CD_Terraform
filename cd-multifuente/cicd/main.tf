...
module "pipeline_fuente_postgres" {
  ...
  branch               = var.branch
  path_filter          = "cd-multifuente/fuentes/fuente-postgres/**"
  buildspec_path       = "cd-multifuente/fuentes/fuente-postgres/buildspec.yml"
  apply_buildspec_path = "cd-multifuente/fuentes/fuente-postgres/buildspec-apply.yml"
...
module "pipeline_fuente_sqlserver" {
  ...
  repo_full_name       = var.repo_full_name
  branch               = var.branch
  path_filter          = "cd-multifuente/fuentes/fuente-sqlserver/**"
  buildspec_path       = "cd-multifuente/fuentes/fuente-sqlserver/buildspec.yml"
  apply_buildspec_path = "cd-multifuente/fuentes/fuente-sqlserver/buildspec-apply.yml"
  artifact_bucket      = var.artifact_bucket
  environment          = var.environment
  tfstate_bucket       = var.platform_state_bucket
  tfstate_region       = var.platform_state_region
