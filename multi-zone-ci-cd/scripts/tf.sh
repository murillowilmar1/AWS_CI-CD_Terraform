#!/usr/bin/env bash
# Uso (correr desde dentro de multi-zone-ci-cd/):
...
# services/x/infra -> key multi-zone-ci-cd/services/x/{env}/terraform.tfstate
STATE_KEY="multi-zone-ci-cd/${MODULE_PATH%/infra}/${ENV}/terraform.tfstate"
